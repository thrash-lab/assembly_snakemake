...
sample=ARD_V2_S1
sample_dir=/project/thrash_89/db/EAGER_metaG_for_ck/ARD_V2_S1_investigation/binning/K99/concoct_subcontigs
...
#concoct_coverage_table.py ${sample_dir}/contigs_10K.bed /project/thrash_89/db/EAGER_metaG_for_ck/ARD_V2_S1_investigation/read_mapping/ARD_V2_S1_K99.bam > ${sample_dir}/coverage_table.csv
